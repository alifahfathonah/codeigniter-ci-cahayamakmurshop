...
<head>
    <meta charset="utf-8" />
    <title>Login | Cahaya Makmur Online Shop</title>
...
<body class="login">
    ...
    <div class="logo">
        ...
        ?>
        <img  src="<?php echo base_url();?>images/logo/a.png" width="400px" alt="" /> 
    </div>
    <div class="content">
    ...
    <?php if($this->session->flashdata('error')) { ?>
                <div class="alert alert-error">
                   <span>Gagal! Email atau password salah!</span>  
                </div>
                <?php } ?>


            <?php echo form_open('home/proses_login','class="form-vertical"'); ?>          
            ...
            <div class="form-actions">
               <a class="btn blue" href="<?php echo base_url();?>home"></i>Kembali Ke Halaman Utama</a>
