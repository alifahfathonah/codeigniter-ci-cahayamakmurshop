...
<div class="row-fluid inbox">
					...
					<div class="span2">
						<ul class="inbox-nav margin-bottom-10">
							<li class="compose-btn">
								...
								<i class="icon-edit"></i> Tulis Email
								</a>
							</li>
					...
					<form   method="POST" action="<?php echo base_url();?>adminweb/buku_tamu_add_simpan">
					<div class="span10">
						...
						<div class="inbox-compose form-horizontal" >
							...
							<div class="inbox-control-group">
								...
								<div class="controls">
									<input type="text" class="m-wrap span12" name="email" id="email" required>
							...
							<div class="inbox-control-group">
								...
								<div class="controls">
									<input type="text" class="m-wrap span12" name="judul" id="judul" required>
								</div>
							</div>
							<div class="inbox-control-group">
								<textarea class="span12  wysihtml5 m-wrap" name="isi_buku_tamu_kirim" id="isi_buku_tamu_kirim" rows="12" required></textarea>
							</div>
