...
<body>
				...
				<div class="row">
					<div class="col-sm-4">
						<div class="logo pull-left">
							...
							?>
							<a href="<?php echo base_url();?>"><img class="imglogo" src="<?php echo base_url();?>images/logo/<?php echo $logo;?>" alt="Adriano MX Online Shop" /></a>
						</div>
					...
					<div class="col-sm-8">
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">
								<li><a href="<?php echo base_url();?>home/tentang_kami_login"> Tentang Kami</a></li>
								<li><a href="<?php echo base_url();?>home/cara_belanja_login"> Cara Belanja</a></li>
								<li><a href="<?php echo base_url();?>home/hubungi_kami_login"> Hubungi Kami</a></li>
								<li><a href="<?php echo base_url();?>home/keranjang_login"> Keranjang Belanja</a></li>
							</ul>
						</div>
					</div>
				</div>
					...
					<div class="col-sm-9">
						...
						<div class="mainmenu pull-left">
							<ul class="nav navbar-nav collapse navbar-collapse">
								<li><a href="<?php echo base_url();?>home/belanja" class="active">Home</a></li>
								<li><a href="<?php echo base_url();?>home/logout">Logout</a></li>
								<li class="dropdown"><a href="#">Kategory<i class="fa fa-angle-down"></i></a>
								<li><a href="<?php echo base_url();?>home/pemesanan">Kembali Ke Panel</a></li>
                                    <ul role="menu" class="sub-menu">
                                    	<?php
                                    	foreach ($kategori->result_array() as $value) { ?>
                                    		
                                        <li><a href="<?php echo base_url();?>home/kategori_login/<?php echo $value['id_kategori'];?>"><?php echo $value['nama_kategori'];?></a></li>
                                    	<?php
                                    	}
                                    	?>
						...
						<div class="carousel-inner">
							...
							foreach ($slider->result_array() as $value) { 
								...
								<div class="item active">
									<div class="col-sm-6">
										<h1><span><img src="<?php echo base_url();?>images/logo/logo1.png" width="300px"></span></h1>
										<!--<h1><span>Cahaya Makmur</span>-Shop</h1>-->
										<h2><?php echo $value['tittle'];?></h2>
										<p><?php echo strip_tags(substr($value['description'],0,300));?></p>
						...
						<div class="panel-group category-products" id="accordian"><!--category-productsr-->
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title"><a href="<?php echo base_url();?>home/kategori_login/<?php echo $value['id_kategori'];?>"><?php echo $value['nama_kategori'];?></a></h4>
								</div>
							</div>		
							<?php
							}
						...
						<div class="brands_products"><!--brands_products-->
							...
							<div class="brands-name">
								<ul class="nav nav-pills nav-stacked">
									...
									<li><a href="<?php echo base_url();?>home/brand_login/<?php echo $value['id_brand'];?>"> <span class="pull-right"></span><?php echo $value['nama_brand'];?></a></li>
							...
							<div class="product-image-wrapper">
								<div class="single-products">
										<div class="productinfo text-center">
											...
											<h2><?php echo 'Rp.'.$this->cart->format_number($value['harga']);?></h2>
											...
											<a href="<?php echo base_url();?>home/keranjang_login/<?php echo $value['id_produk'];?>" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
										</div>
										<div class="product-overlay">
											<div class="overlay-content">
												<h2><?php echo 'Rp.'.$this->cart->format_number($value['harga']);?></h2>
												<!--<p><p><?php echo $value['kode_produk'];?></p>-->
												<a href="<?php echo base_url();?>home/produk/<?php echo $value['id_produk'];?>"><p> <?php echo $value['nama_produk'];?></p></a>
												<a href="<?php echo base_url();?>home/keranjang_login/<?php echo $value['id_produk'];?>" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
											</div>
										</div>
	...
	<footer id="footer"><!--Footer-->
		...
		<div class="footer-bottom">
			<div class="container">
				<div class="row">
					<p class="pull-left">Copyright © 2018 Cahaya Makmur Online Shop. All rights reserved.</p>
