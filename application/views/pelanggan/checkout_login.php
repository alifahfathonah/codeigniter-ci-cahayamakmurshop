...
?>
				...
				<div class="row">
					<div class="col-sm-3">
						<div class="shopper-info">
							<p>Data Pembeli</p>
							<?php echo form_open('home/checkout_invoice_login');?>
								<input type="text" name="id_user" value="<?=$id_user;?>" readonly>
								...
								<input type="hidden" placeholder="Ongkos kirim akan disi oleh admin" name="ongkos_kirim">
	...
	<footer id="footer"><!--Footer-->
		...
		<div class="footer-bottom">
			<div class="container">
				<div class="row">
					<p class="pull-left">PT Cahaya Makmur Textile. All rights reserved.</p>
				</div>
			</div>
		</div>
