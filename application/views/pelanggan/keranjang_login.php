...
<body>
	...
	<section id="cart_items">
		<div class="container">
			...
			?>
			<?php echo form_open('home/keranjang_update_login'); ?>
		...
		<tr <?php if($i&1){ echo 'class="alt"'; }?>>
			...
			<select name="qty[]" class="input-teks">
	  		...
	  		<td><a href="<?php echo base_url()?>images/produk/<?=$items['gambar']?>"><img width="100px" src="<?php echo base_url()?>images/produk/<?=$items['gambar']?>"></a></td>
 		 	...
 		 	<td class="td-keranjang" align="center"><a href="<?php echo base_url(); ?>home/keranjang_hapus_login/<?php echo $items['rowid']; ?>"><i class="fa fa-times"></i></a></td>
	  	</tr>
		...
		<tr>
			<td class="td-keranjang" colspan=3><b>Total Belanja</b></td>
 		 	<td class="td-keranjang" colspan=2>Rp. <?php echo $this->cart->format_number($this->cart->total()); ?></td>
				...
				<a href="<?php echo base_url('home/belanja/'.$this->session->userdata('id_user'))?>"><div class="btn btn-default get">Lanjut Belanja</div></a>
				<a href="<?php echo base_url(); ?>home/checkout_login"><div class="btn btn-default get">Selesai Belanja</div></a>
			</div>
